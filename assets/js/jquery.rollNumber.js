...
(function($) {
  $.fn.rollNumber = function(options) {
    ...
    numberHtml = `<div class="_number number_width" style="width: ${ space }px; height: ${ _height }px; line-height: ${ _height }px; display: flex; justify-content: center; align-items: center;"><div class="inner_number_width" style="position: relative; width: ${ space }px; height: ${ _height }px; overflow: hidden;"><div class="inner_number_width2" style="position: absolute; width: 100%;">${ numberHtml }</div></div></div>`
